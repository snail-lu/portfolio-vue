<template>
    <demo :data="demoInfo">
        ...
        >
            <el-table-column prop="date" label="日期" sortable="custom" :sort-orders="['ascending', 'descending']" />
...
export default {
    ...
    data() {
        return {
            demoInfo: {
                title: '表格自定义排序',
                url: 'https://snail-lu.vercel.app/2020-05-07-element-ui-zhong-biao-ge-zi-ding-yi-pai-xu.html'
            },
            tableData: [
                {
                    date: '2014-12-02',
